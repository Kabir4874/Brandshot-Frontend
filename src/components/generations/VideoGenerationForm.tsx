...
export default function VideoGenerationForm() {
  ...
  const videoGenerationForm = useForm({
    defaultValues: {
      yourIndustry: "",
  ...
  const handleSubmit = async (formData: any) => {
    ...
    try {
      const response = await fetch(`${backendUrl}/ad-creative`, {
        method: "POST",
  ...
  return (
    <div className="space-y-6">
      <form
        onSubmit={videoGenerationForm.handleSubmit((data) => handleSubmit(data))}
      >
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {/* Left Side - Form */}
          <div className="space-y-4">
            <h3 className="text-lg font-semibold">Generate Video Ad</h3>
            <div className="space-y-4">
              <div>
                ...
                <Controller
                  name="yourIndustry"
                  control={videoGenerationForm.control}
                  rules={{ required: true }}
                  render={({ field }) => (
                    <Select
                ...
                />
                {videoGenerationForm.formState.errors.yourIndustry && (
              ...
              <div>
                ...
                />
                {videoGenerationForm.formState.errors.adPlatform && (
                  <p className="text-red-500 text-xs mt-1">
              ...
              <div>
                ...
                />
                {videoGenerationForm.formState.errors.campaignObjective && (
                  <p className="text-red-500 text-xs mt-1">
              ...
              <div>
                ...
                <Textarea
                  {...videoGenerationForm.register("targetAudience", {
                    required: true,
                  })}
                  ...
                  disabled={isLoading}
                />
                {videoGenerationForm.formState.errors.targetAudience && (
                  <p className="text-red-500 text-xs mt-1">
              ...
              <div>
                ...
                <Textarea
                  {...videoGenerationForm.register("keyMessages", {
                    required: true,
                  })}
                  ...
                  disabled={isLoading}
                />
                {videoGenerationForm.formState.errors.keyMessages && (
                  <p className="text-red-500 text-xs mt-1">
              ...
              <div>
                ...
                <Textarea
                  {...videoGenerationForm.register("brandGuidelines", {
                    required: true,
                  })}
                  ...
                  disabled={isLoading}
                />
                {videoGenerationForm.formState.errors.brandGuidelines && (
                  <p className="text-red-500 text-xs mt-1">
              ...
              <div>
                ...
                />
                {videoGenerationForm.formState.errors.upscaleImage && (
                  <p className="text-red-500 text-xs mt-1">
